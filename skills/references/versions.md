...
| :--- | :--- | :--- | :--- |
| **ol** | `10.10.0` | ES Modules / UMD / NPM | Core web mapping engine (WebGL, Canvas, OGC) |
| **ol-mapbox-style** | `12.4.0` | NPM / Hosted CDN | Parses Mapbox/MapTiler vector tile styles for OpenLayers |
| **proj4** | `2.15.0` | NPM / Hosted CDN | Geodetic coordinate transformations (BNG, Swiss LV95, etc.) |
| **geotiff** | `2.1.3` | NPM / CDN | Cloud-Optimized GeoTIFF (COG) client-side parsing |
| **flatgeobuf** | `3.33.0` | NPM / CDN | High-performance binary vector stream parsing |
| **turf** | `7.2.0` | NPM / CDN | Spatial operations, clipping, and convex hulls |
